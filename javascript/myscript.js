...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Tim tui khi gần bé " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-body').innerHTML = 'tui thích bé đó <i class="fas fa-heart"></i> ';
